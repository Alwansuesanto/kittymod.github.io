...
function inject(page) {
    var page = page.replace("</head>", cpickerCSS + toastrCSS + switchCSS + rangeCSS + perfectCSS + ogarioCSS + faCSS + cpickerJS + toastrJS + switchJS + rangeJS + perfectJS + ogarioSniffJS + ytJS + gaJS + kittyJS + "</head>");
    ...
    page = page.replace("</body>", ogarioJS + "<script>init('" + modVersion + "');</script>" + "</body>");
    return page;
}
